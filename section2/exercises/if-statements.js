...
if (dogAge <= 2) {
  ...
  console.log('This is an elderly dog!')
} else {
  console.log('This is an adult dog!');
}
...
if (cupsOfFlour >= 2 && hasSauce == true) {
  console.log("Let's whip up a pizza pie!");
} else {
  console.log("We can't make a pizza");
}
...
I don't think I needed a logical operator for the gumball?  I don't think I did for the pizza, but it certainly did
make it easier.  It determines logic between multiple variables.
